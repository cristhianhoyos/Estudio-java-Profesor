...
public class LenguajeEntity {
	...
	private Set <ProfesoresEntity> profesores = new HashSet<ProfesoresEntity>();
	...
	public Set<ProfesoresEntity> getProfesores() {
		return profesores;
	}

	public void setProfesores(Set<ProfesoresEntity> profesores) {
